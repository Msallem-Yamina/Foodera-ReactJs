...
// test existing of items In LocalStorage
const items =
  localStorage.getItem("cartItems") !== null
    ? JSON.parse(localStorage.getItem("cartItems"))
    : [];

// test existing of totalAmount In LocalStorage
const totalAmount =
  localStorage.getItem("totalAmount") !== null
    ? JSON.parse(localStorage.getItem("totalAmount"))
    : 0;
// test existing of Quantity In LocalStorage
const totalQuantity =
  ...
  reducers: {
    ...
    addItem(state, action) {
      const newItem = action.payload,
       ...
       extraIngredients = action.payload.extraIngredients,
